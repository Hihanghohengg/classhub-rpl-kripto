...
const practices = [
  ...
  },
  {
    ...
    description:
      'Simulator latihan praktik tentang pipeline Machine Learning, Data Leakage, Hyperparameter Tuning, evaluasi model, RNN, dan LSTM.',
  ...
  {
    id: 'metlit-interactive',
    title: 'Metodologi Penelitian Interactive',
    course: 'Metodologi Penelitian',
    description:
      'Materi pembelajaran interaktif berupa mind map, flashcard, visual learning, dan simulasi konsep penelitian.',
    url: '/practice/metlit.html',
    ...
    <div className="flex h-full min-h-0 flex-col bg-slate-50 p-4 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      <div className="mb-4 shrink-0">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Kumpulan media pembelajaran interaktif, CBT, simulator, dan modul latihan
          untuk membantu memahami materi kuliah.
        </p>
      </div>
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Pilih latihan yang ingin dipelajari.
              </p>
            </div>
          </div>
